...
export default {
    ...
    // Page layout
    'app.page.main.text': '1123Basic configuration of the project using React + Redux + Bootstrap.',
    ...
    'app.user.table.login': 'Login',
    'app.user.table.firstName': 'First Name',
    'app.user.table.lastName': 'Last Name',
